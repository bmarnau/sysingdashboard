...
- Handbuchversion 1.22.0,
- Routenhilfe: spezifischste Route gewinnt vor generischem `/`-Match,
- veraltete Handbuchtexte zu Kundenverantwortung, RBAC (acht Rollen / 23 Permissions) und „Betrieb ohne Azure“ auf den aktuellen Supabase-MVP-Stand korrigiert,
