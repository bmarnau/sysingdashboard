...
Planungsbasis: GitHub `main` `181b0a001214164208309b6f7cc851535fba2faa`  
Vorgänger: BSF-03B / PR #149, finaler Kandidat `92712927c80576467ac4c7020a4dab75a79455f6`, FINAL DONE aber noch DRAFT / nicht gemergt
...
- eindeutige Zuordnung zur Shared Projection → kontrollierter Backfill,
- fehlende oder mehrdeutige Zuordnung → `UNRESOLVED` / fail-closed für BSF-03E,
- keine automatische Zuordnung über Namen oder Titel,
- keine Löschung historischer AVKK-Daten.

Erst nach belegtem Backfill darf die alte globale Eindeutigkeit durch die gescopte Eindeutigkeit ersetzt werden.
...
Produktcode für BSF-03E startet nicht auf einer veralteten Basis.

Vor P0:

- PR #149 / BSF-03B muss entweder nach `main` gemergt sein oder der BSF-03E-Arbeitsbranch muss bewusst auf dem finalen BSF-03B-Head aufsetzen,
- neue Implementierung immer gegen den dann aktuellen GitHub-`main` rebasen/prüfen,
