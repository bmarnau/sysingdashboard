...
| F-11             | low     | Fachliche Abzeichnung der Rollenabnahme steht aus; Checkliste, automatisierte Nachweise und seit v1.58.3 ein Mehrbenutzer-Demoszenario mit vier Personen liegen vor (`docs/ROLE-ACCEPTANCE-09C.md`, `docs/DEMO-USERS.md`)                     | Dokumentation der Oberflächenabnahme                                                                                                                                                                | v1.58.9: manueller Befund behoben (Seed hängt Verantwortungen bestehender Demofälle auf die Persona um, lokaler Bestand je Konto erforderlich); Wiederholungsprüfung und Unterschrift bleiben MANUAL VERIFICATION REQUIRED                                                                                                                                                                                                                                                                                                                             |
| F-16             | low     | Demo-Seed übersprang vorhandene offene Demofälle vollständig, wodurch eine geänderte Personenzuordnung nie wirksam wurde; zusätzlich bleibt der lokale Aufgabenbestand browsergebunden, sodass „Mein AVKK" ohne eigenes Einspielen leer wirkt | falscher Eindruck fehlender persönlicher AVKK-Daten                                                                                                                                                 | behoben in v1.58.9: Abgleich der Verantwortung statt Überspringen, Fehlversuche werden gemeldet, Dialoghinweis zum lokalen Bestand je Anmeldung                                                                                                                                                                                                                                                                                                                                                                                                        |
| F-13             | medium  | AVKK-Leseregeln prüfen nur `avkk.view`; jede lesende Rolle sieht alle Sachverhalte, „Mein AVKK" trennt nur in der Sicht                                                                                                                       | keine Lesetrennung zwischen Personen                                                                                                                                                                | bewusste Produktentscheidung (Sachverhalt statt Personendaten); zeilenbezogene Leseregeln als Post-MVP-Entscheidung offen                                                                                                                                                                                                                                                                                                                                                                                                                              |
| F-14             | low     | Projekte, Arbeitspakete und Tätigkeiten liegen lokal im Browser ohne Zugriffsregeln                                                                                                                                                           | keine Personen- oder Gerätetrennung im lokalen Bestand                                                                                                                                              | bekannte Local-First-Grenze (ADR-0003), Serverablösung Post-MVP                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| F-15             | medium  | Kein externer Administrationszugang des Betreibers zur Betriebsplattform (plattformverwaltete Instanz); Kontopflege nur ueber das Dashboard moeglich                                                                                          | Betriebsfaehigkeit bei Kontostoerungen                                                                                                                                                              | v1.58.7: Servicebereich „Backend & Auth-Konten" mit Statusanzeige und Kontoaktionen ergaenzt; kein MVP-Blocker                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| F-16 (Auth-Mail) | medium  | Recovery-Mails werden ohne eigene Absenderdomäne über den Standardabsender der Plattform versendet und erreichen externe Adressen unzuverlässig                                                                                               | Kontowiederherstellung blockiert                                                                                                                                                                    | behoben in v1.59.2: administratives Passwortsetzen im Servicebereich „Backend & Auth-Konten" (Rollen-, Eigenkonto- und Systemadministratorschutz, Drosselung, Prüfprotokoll ohne Passwort)                                                                                                                                                                                                                                                                                                                                                             |
| F-17             | low     | Kein technisch erzwungener Passwortwechsel nach administrativer Setzung (Auth-Dienst bietet kein „must change" Kennzeichen)                                                                                                                   | Benutzer kann das gesetzte Passwort beibehalten                                                                                                                                                     | akzeptiert für MVP, Hinweis in Dialog und Handbuch, BSF-Follow-up                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| F-18             | high    | Lokales CRUD fuer Projekte, Arbeitspakete und Taetigkeiten war nicht durchgaengig mit der bestehenden RBAC-Matrix verbunden (globales „+ Neu" ohne Pruefung, Handler ohne defensive Pruefung)                                                 | Read-only-Rollen (viewer, customer) konnten Fachobjekte im eigenen lokalen Browserbestand anlegen, aendern und loeschen; keine serverseitige Rechteausweitung, keine Veraenderung fremder Bestaende | behoben in v1.59.3: UI-Gating je Permission (`project.edit`, `workpackage.edit`, `activity.edit`) plus defensive Berechtigungspruefung unmittelbar vor jeder lokalen Mutation; Regressionstests fuer viewer/customer und berechtigte Rollen. Restfix in v1.59.4: manueller Viewer-Retest zeigte verbliebene UI-Pfade ueber die Abrechnungsansicht (fehlendes canEdit) und die globale Suche (Editoeffnung ohne Pruefung); geschlossen durch verpflichtende canEdit-Props, RBAC-konforme Suche und zentrale Dialog-Render-Gates. F-18 technisch behoben |
