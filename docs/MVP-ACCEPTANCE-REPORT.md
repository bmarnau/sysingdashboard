...
| F-11 | low     | Fachliche Abzeichnung der Rollenabnahme steht aus; Checkliste, automatisierte Nachweise und seit v1.58.3 ein Mehrbenutzer-Demoszenario mit vier Personen liegen vor (`docs/ROLE-ACCEPTANCE-09C.md`, `docs/DEMO-USERS.md`) | Dokumentation der Oberflächenabnahme                    | v1.58.3: Szenario und Referenzwerte bereitgestellt; offene Unterschrift bleibt MANUAL VERIFICATION REQUIRED               |
