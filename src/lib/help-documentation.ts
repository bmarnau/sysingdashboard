...
export const DOCUMENTATION_VERSION = "1.19.0";
...
Der Auth-Guard in \`_authenticated/route.tsx\` bildete den Rücksprung-Pfad mit einem Template-Literal
über \`location.pathname\` und \`location.search\`. TanStack Router liefert \`location.search\`
allerdings als **Objekt** (parsed Search-Params), nicht als String. Die implizite String-Coercion warf
\`TypeError: Cannot convert object to primitive value\` — der Guard brach vor dem Redirect ab,
