...
| `/api/sync` | POST | nein | sync.trigger | — | yes | yes | 15 | active | Auth-Gate greift erst in PROD (`SYNC_TRIGGER_TOKEN`); DEV-Modus ist ungeschützt.<br>Kein Rate-Limit — parallele Requests laufen alle durch. |
