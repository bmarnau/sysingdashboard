...
6. **[High/mittel]** Zyklische Abhängigkeit (2 Kanten)
   - Ort: `src/routeTree.gen.ts`
   - Empfehlung: Gemeinsame Types/Utilities in ein drittes Modul extrahieren; Abhängigkeitsrichtung erzwingen.
   - Finding-ID: `td-cycle-4f7048fd`

7. **[High/gross]** Modul überschreitet Größenschwelle (1075 Zeilen)
...
14. **[Low/mittel]** Modul überschreitet Größenschwelle (702 Zeilen)
