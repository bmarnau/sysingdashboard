...
10. **[Medium/klein]** Direktes console.info außerhalb der Logger-Fassade
   - Ort: `src/integrations/supabase/env-check.ts:93`
   - Empfehlung: Auf `logger.info/warn/error` umstellen (`src/lib/logger.ts`).
   - Finding-ID: `td-console-9771f164`

11. **[Medium/klein]** Direktes console.warn außerhalb der Logger-Fassade
   - Ort: `src/integrations/supabase/env-check.ts:82`
   - Empfehlung: Auf `logger.info/warn/error` umstellen (`src/lib/logger.ts`).
   - Finding-ID: `td-console-993be125`

12. **[Medium/klein]** Direktes console.error außerhalb der Logger-Fassade
   - Ort: `src/lib/help-documentation.ts:426`
   - Empfehlung: Auf `logger.info/warn/error` umstellen (`src/lib/logger.ts`).
   - Finding-ID: `td-console-f7820fc7`

13. **[Medium/mittel]** E2E-Suite ist bewusst nur Smoke
   - Ort: `e2e/`
...
14. **[Low/klein]** MSW-Handler decken nur wenige Azure-Endpunkte
...
17. **[High/gross]** Modul überschreitet Größenschwelle (808 Zeilen)
...
18. **[High/gross]** Modul überschreitet Größenschwelle (3281 Zeilen)
   - Ort: `src/routes/_authenticated/dashboard.tsx`
   - Empfehlung: Verantwortlichkeiten identifizieren und in Sub-Module aufteilen (Hooks/Services extrahieren).
   - Finding-ID: `td-oversize-7e9a0b20`

19. **[Medium/klein]** UI-Direktzugriff auf Azure-Interna
...
20. **[Medium/klein]** UI-Direktzugriff auf Persistenz-Schicht
...
63. **[Low/klein]** CI installiert Chromium bei jedem Lauf
...
64. **[Informational/klein]** Kein Coverage-Report vorhanden
