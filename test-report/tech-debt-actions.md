...
6. **[High/gross]** Modul überschreitet Größenschwelle (989 Zeilen)
...
13. **[Low/mittel]** Modul überschreitet Größenschwelle (560 Zeilen)
...
18. **[Low/mittel]** Modul überschreitet Größenschwelle (496 Zeilen)
   - Ort: `src/components/LogViewerDialog.tsx`
   - Empfehlung: Verantwortlichkeiten identifizieren und in Sub-Module aufteilen (Hooks/Services extrahieren).
   - Finding-ID: `td-oversize-d5f3942b`

19. **[Low/mittel]** Modul überschreitet Größenschwelle (563 Zeilen)
